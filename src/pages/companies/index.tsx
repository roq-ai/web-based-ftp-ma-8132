...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'ftp_account.count', 'invitation.count', 'member.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('ftp_account', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'ftp_account',
          header: 'Ftp Account',
          accessorKey: 'ftp_account',
          cell: ({ row: { original: record } }: any) => record?._count?.ftp_account,
        }
      : null,
